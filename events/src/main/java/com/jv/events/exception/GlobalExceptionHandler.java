...
public class GlobalExceptionHandler {
        ...
        @ExceptionHandler(EventCancellationNotAllowedException.class)
        public ResponseEntity<ErrorResponseDTO> handleEventCancellationNotAllowed(
                        EventCancellationNotAllowedException ex,
                        WebRequest request) {
                logger.warn("Cancelamento de evento não permitido: {}", ex.getMessage());
